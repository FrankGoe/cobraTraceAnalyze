...
var NumberBoxMask = NumberBoxBase.inherit({
    ...
    _tryReplace: function(text, selection, char) {
        var start = selection.start,
            ...
            replaced = this._getEditedText(text, {
                start: start,
                end: end
            }, replacement);
    ...
    _tryParse: function(text, selection, char) {
        var inserted = this._tryInsert(text, selection, char),
            ...
            value = ensureDefined(inserted, ensureDefined(leadingZeroAdded, ensureDefined(replaced, ensureDefined(lightParsed, noLeadingZeros))));
        return value
    },
    ...
    _setInputText: function(text, position) {
        var oldLength = (this._formattedValue || "").length,
            ...
            caretDelta = 0;
        if ("" === this._formattedValue && null !== this._parsedValue) {
    ...
    _lightParse: function(text) {
        ...
        return isNaN(value) || Math.abs(value) > MAXIMUM_FLOAT_LIMIT ? void 0 : value
    },
